          ...
          <div className="text-center items-center bg-[#232323]  h-full  flex xl:pt-0 lg:overflow-clip">
            <div className="h-fit m-5">
              ...
              <p className="text-sm md:text-xl text-white font-medium pt-4">
                I'm a Computer Science Engineering student skilled in<span className="text-green-main"> web
                development, mobile app development with Flutter, React &
                Tailwind CSS.</span> As a former IEDC Creative Lead during my diploma,
                I excel in leadership & teamwork.
                <br />
              ...
              <div className="grid grid-cols-1 text-White-main font-medium md:grid-cols-2 md:justify-items-start">
                ...
                <h1>badushapareeth@gmail.com</h1>
              </div>
